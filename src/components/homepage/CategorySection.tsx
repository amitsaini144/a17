                ...
                <div className="flex gap-5">
                    <div className="flex flex-col">
                        ...
                        <div className="bg-[#f7f7f7] rounded-b-3xl">
                            <Image src="/ultrawatch.png" alt="Headphones x-28m" width={600} height={360} quality={90} priority />
                        </div>
                    </div>
                    <div className="flex flex-col gap-4">
                        <div className="flex">
                            <div className="flex flex-col gap-20 bg-[#f7f7f7] p-10 pr-0 rounded-l-3xl">
                                <div className="flex flex-col gap-2">
                            ...
                            <div className="bg-[#f7f7f7] rounded-r-3xl">
                                <Image src="/eDisplay.png" alt="monitor" width={450} height={200} quality={90} priority />
                            </div>
                        </div>
                        <div className="flex gap-6">
                            <div className="bg-[#f7f7f7] rounded-3xl overflow-hidden">
                                <Image src="/whiteHeadphone.png" alt="headphone" width={400} height={600} quality={90} priority className="mix-blend-multiply" />
                            </div>
                            <div className="bg-[#f7f7f7] rounded-3xl overflow-hidden">
                                <Image src="/iphonepro.png" alt="phone" width={400} height={600} quality={90} priority className="mix-blend-multiply" />
                            </div>
                        </div>
                    </div>
                </div>
